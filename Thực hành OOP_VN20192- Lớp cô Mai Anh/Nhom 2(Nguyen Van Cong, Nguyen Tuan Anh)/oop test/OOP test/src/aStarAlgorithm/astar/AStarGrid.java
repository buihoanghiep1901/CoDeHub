...
public class AStarGrid<T> {
	...
	/**
	 * Get neighboring cells relative to the given cell. By default they are
	 * top/right/bottom/left. If allowDiagonals is enabled, then also top-left,
	 * top-right, bottom-left, bottom-right cells are in the results.
	 * 
	 * @param cell
