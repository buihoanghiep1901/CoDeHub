...
/**
 * A virtual cell which defines if it is traversable. The cell is used to store
 * the f,g,h values of the A* algorithm.
 * 
 * @param <T> You can use {@link #obj} to store information about e. g. an
 *            external object.
 */
public class AStarCell<T> implements Cloneable {
	...
	/**
	 * A pointer to an object of your choice. Unused in the A* algorithm. Usually
	 * you convert your grid to the (virtual) A* grid, then find the path.
