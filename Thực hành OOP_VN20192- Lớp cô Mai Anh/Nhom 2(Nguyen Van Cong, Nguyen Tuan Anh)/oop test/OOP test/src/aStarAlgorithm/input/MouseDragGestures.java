...
public class MouseDragGestures {
	...
	public void makeDraggable(Node node) {
		// using event filter here instead of setOnMouse... because we need a proper
		// order of the filter handling;
		// reason: in main we got an additional released filter which draws the path
		// automatically
